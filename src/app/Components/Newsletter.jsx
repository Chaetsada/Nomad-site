      ...
      <div className="container h-full grid place-items-center">
        <div className="h-fit w-full px-6 py-10 md:py-32 flex flex-col justify-center items-center bg-secondary-100 rounded-2xl relative">
          ...
          <div className="flex flex-col md:flex-row gap-3">
            <input
              className="px-5 py-4 rounded-md w-full md:w-[400px] outline-none"
              type="email"
              placeholder="Enter your email"
            />
            <button className="px-5 py-4 w-full md:w-fit text-white bg-primary-100 font-bold rounded-md hover:opacity-80 active:scale-90">
              Subscribe
            </button>
          </div>
          {/* STAT */}
